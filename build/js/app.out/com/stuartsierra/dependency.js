...
return cljs.core.reduce.call(null,(function (m,p__4602){
var vec__4603 = p__4602;
var k = cljs.core.nth.call(null,vec__4603,(0),null);
var vs = cljs.core.nth.call(null,vec__4603,(1),null);
...
var vec__4606 = temp__5455__auto__;
var seq__4607 = cljs.core.seq.call(null,vec__4606);
var first__4608 = cljs.core.first.call(null,seq__4607);
var seq__4607__$1 = cljs.core.next.call(null,seq__4607);
var node = first__4608;
var more = seq__4607__$1;
if(cljs.core.contains_QMARK_.call(null,expanded,node)){
var G__4609 = more;
var G__4610 = expanded;
unexpanded = G__4609;
expanded = G__4610;
continue;
} else {
var G__4611 = cljs.core.concat.call(null,more,neighbors.call(null,node));
var G__4612 = cljs.core.conj.call(null,expanded,node);
unexpanded = G__4611;
expanded = G__4612;
continue;
}
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k4614,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k4614,else__4206__auto__);
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__4613){
var self__ = this;
var G__4613__$1 = this;
return (new cljs.core.RecordIter((0),G__4613__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this4615,other4616){
var self__ = this;
var this4615__$1 = this;
return ((!((other4616 == null))) && ((this4615__$1.constructor === other4616.constructor)) && (cljs.core._EQ_.call(null,this4615__$1.dependencies,other4616.dependencies)) && (cljs.core._EQ_.call(null,this4615__$1.dependents,other4616.dependents)) && (cljs.core._EQ_.call(null,this4615__$1.__extmap,other4616.__extmap)));
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__4613){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__4619 = cljs.core.keyword_identical_QMARK_;
var expr__4620 = k__4211__auto__;
if(cljs.core.truth_(pred__4619.call(null,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),expr__4620))){
return (new com.stuartsierra.dependency.MapDependencyGraph(G__4613,self__.dependents,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__4619.call(null,new cljs.core.Keyword(null,"dependents","dependents",136812837),expr__4620))){
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,G__4613,self__.__meta,self__.__extmap,null));
} else {
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4211__auto__,G__4613),null));
}
}
});
...
com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__4613){
var self__ = this;
var this__4202__auto____$1 = this;
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,G__4613,self__.__extmap,self__.__hash));
});
 ...
 */
com.stuartsierra.dependency.map__GT_MapDependencyGraph = (function com$stuartsierra$dependency$map__GT_MapDependencyGraph(G__4617){
var extmap__4236__auto__ = (function (){var G__4622 = cljs.core.dissoc.call(null,G__4617,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837));
if(cljs.core.record_QMARK_.call(null,G__4617)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__4622);
} else {
return G__4622;
}
})();
return (new com.stuartsierra.dependency.MapDependencyGraph(new cljs.core.Keyword(null,"dependencies","dependencies",1108064605).cljs$core$IFn$_invoke$arity$1(G__4617),new cljs.core.Keyword(null,"dependents","dependents",136812837).cljs$core$IFn$_invoke$arity$1(G__4617),null,cljs.core.not_empty.call(null,extmap__4236__auto__),null));
});
...
return cljs.core.empty_QMARK_.call(null,com.stuartsierra.dependency.immediate_dependents.call(null,graph,p1__4624_SHARP_));
});})(sorted,g))
...
var vec__4625 = cljs.core.seq.call(null,todo);
var seq__4626 = cljs.core.seq.call(null,vec__4625);
var first__4627 = cljs.core.first.call(null,seq__4626);
var seq__4626__$1 = cljs.core.next.call(null,seq__4626);
var node = first__4627;
var more = seq__4626__$1;
var deps = com.stuartsierra.dependency.immediate_dependencies.call(null,g,node);
var vec__4628 = (function (){var deps__$1 = deps;
var g__$1 = g;
...
var G__4631 = cljs.core.rest.call(null,deps__$1);
var G__4632 = g_SINGLEQUOTE_;
var G__4633 = cljs.core.conj.call(null,add,d);
deps__$1 = G__4631;
g__$1 = G__4632;
add = G__4633;
continue;
} else {
var G__4634 = cljs.core.rest.call(null,deps__$1);
var G__4635 = g_SINGLEQUOTE_;
var G__4636 = add;
deps__$1 = G__4634;
g__$1 = G__4635;
add = G__4636;
...
var add = cljs.core.nth.call(null,vec__4628,(0),null);
var g_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__4628,(1),null);
var G__4637 = cljs.core.cons.call(null,node,sorted);
var G__4638 = com.stuartsierra.dependency.remove_node.call(null,g_SINGLEQUOTE_,node);
var G__4639 = clojure.set.union.call(null,cljs.core.set.call(null,more),cljs.core.set.call(null,add));
sorted = G__4637;
g = G__4638;
todo = G__4639;
continue;
