...
/** @this {Function} */
sablono.util.as_str.cljs$lang$applyTo = (function (seq5165){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq5165));
});
...
var vec__5169 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__5170 = cljs.core.seq.call(null,vec__5169);
var first__5171 = cljs.core.first.call(null,seq__5170);
var seq__5170__$1 = cljs.core.next.call(null,seq__5170);
var first_word = first__5171;
var words = seq__5170__$1;
...
var G__5172 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__5172,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__5172;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__5173_SHARP_){
if(typeof p1__5173_SHARP_ === 'string'){
return p1__5173_SHARP_;
} else {
return cljs.core.seq.call(null,p1__5173_SHARP_);
