...
var len__4531__auto___4694 = arguments.length;
var i__4532__auto___4695 = (0);
while(true){
if((i__4532__auto___4695 < len__4531__auto___4694)){
args__4534__auto__.push((arguments[i__4532__auto___4695]));

var G__4696 = (i__4532__auto___4695 + (1));
i__4532__auto___4695 = G__4696;
continue;
} else {
}
break;
...
/** @this {Function} */
sablono.util.as_str.cljs$lang$applyTo = (function (seq4693){
...
var vec__4697 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__4698 = cljs.core.seq.call(null,vec__4697);
var first__4699 = cljs.core.first.call(null,seq__4698);
var seq__4698__$1 = cljs.core.next.call(null,seq__4698);
var first_word = first__4699;
var words = seq__4698__$1;
...
var G__4700 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__4700,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__4700;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__4701_SHARP_){
if(typeof p1__4701_SHARP_ === 'string'){
return p1__4701_SHARP_;
} else {
return cljs.core.seq.call(null,p1__4701_SHARP_);
