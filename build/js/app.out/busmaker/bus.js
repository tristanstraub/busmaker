...
return cljs.core.mapv.call(null,(function (p1__5110_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"n","n",562130025),new cljs.core.Keyword(null,"recipes","recipes",-325236209),new cljs.core.Keyword(null,"facility","facility",-2118099900)],[(1),busmaker.bus.factory_outputs.call(null,busmaker.recipes.factory_type.call(null,p1__5110_SHARP_),p1__5110_SHARP_),busmaker.recipes.factory_type.call(null,p1__5110_SHARP_)]);
}),cljs.core.remove.call(null,busmaker.recipes.raw_QMARK_,cljs.core.first.call(null,cljs.core.reduce.call(null,(function (p__5111,recipe_name){
var vec__5112 = p__5111;
var recipe_names__$1 = cljs.core.nth.call(null,vec__5112,(0),null);
var outputs = cljs.core.nth.call(null,vec__5112,(1),null);
var state = vec__5112;
...
return (function (p1__5115_SHARP_){
return cljs.core.every_QMARK_.call(null,existing_recipes,new cljs.core.Keyword(null,"recipes","recipes",-325236209).cljs$core$IFn$_invoke$arity$1(p1__5115_SHARP_));
});})(existing_recipes))
,new_factories));
});
...
var _PERCENT_ = cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__5116_SHARP_){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([recipe_name]),new cljs.core.Keyword(null,"recipes","recipes",-325236209).cljs$core$IFn$_invoke$arity$1(p1__5116_SHARP_));
}),factories));
