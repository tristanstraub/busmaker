...
return cljs.core.update.call(null,state,new cljs.core.Keyword(null,"bus-outputs","bus-outputs",-2007555584),(function (p1__5089_SHARP_){
return cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([recipe_name]),p1__5089_SHARP_));
}));
});
busmaker.state.swap_facility = (function busmaker$state$swap_facility(state,factory,facility){
return cljs.core.update.call(null,state,new cljs.core.Keyword(null,"factories","factories",1443149712),(function (p1__5090_SHARP_){
...
return cljs.core.update.call(null,state,new cljs.core.Keyword(null,"factories","factories",1443149712),(function (p1__5091_SHARP_){
return cljs.core.mapv.call(null,(function (f){
if(cljs.core._EQ_.call(null,factory,f)){
