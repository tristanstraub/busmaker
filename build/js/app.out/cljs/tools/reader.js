...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__7657 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7657,ch);
...
if(("\\" === ch__$1)){
var ch_7658__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_7658__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_7658__$2);
} else {
}

var G__7659 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__7659;
continue;
}
}
...
var vec__7667 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7667,(0),null);
var start_column = cljs.core.nth.call(null,vec__7667,(1),null);
...
var G__7670 = cljs.core.conj_BANG_.call(null,a,form);
a = G__7670;
continue;
}
}
...
var _STAR_read_delim_STAR_7671 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_7671;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__7672 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7672,(0),null);
var start_column = cljs.core.nth.call(null,vec__7672,(1),null);
...
var vec__7675 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7675,(0),null);
var end_column = cljs.core.nth.call(null,vec__7675,(1),null);
...
var vec__7678 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7678,(0),null);
var start_column = cljs.core.nth.call(null,vec__7678,(1),null);
...
var vec__7681 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7681,(0),null);
var end_column = cljs.core.nth.call(null,vec__7681,(1),null);
...
var vec__7687 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7687,(0),null);
var end_column = cljs.core.nth.call(null,vec__7687,(1),null);
...
var sb = (function (){var G__7690 = (new goog.string.StringBuffer());
G__7690.append(initch);
...
var G__7692 = (function (){var G__7691 = sb;
G__7691.append(ch);

return G__7691;
})();
var G__7693 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__7692;
ch = G__7693;
continue;
}
...
switch (G__7696) {
case "\\":
var G__7700 = (function (){var G__7697 = sb;
G__7697.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__7697;
})();
var G__7701 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__7700;
ch = G__7701;
continue;
...
break;
default:
var G__7702 = (function (){var G__7698 = sb;
G__7698.append(ch);

return G__7698;
})();
var G__7703 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__7702;
ch = G__7703;
continue;
...
var vec__7704 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7704,(0),null);
var end_column = cljs.core.nth.call(null,vec__7704,(1),null);
...
var vec__7707 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7707,(0),null);
var column = cljs.core.nth.call(null,vec__7707,(1),null);
...
var vec__7712 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7712,(0),null);
var column = cljs.core.nth.call(null,vec__7712,(1),null);
...
var vec__7717 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__7717,(0),null);
var column = cljs.core.nth.call(null,vec__7717,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__7722 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__7722,(0),null);
var start_column = cljs.core.nth.call(null,vec__7722,(1),null);
...
var vec__7725 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__7725,(0),null);
var end_column = cljs.core.nth.call(null,vec__7725,(1),null);
...
var G__7728 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__7728,true,null,opts,pending_forms);
...
var G__7729 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__7729)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__7729)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__7729)){
...
var _STAR_suppress_read_STAR_7730 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7730;
}});
...
var G__7731 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__7731,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__7731,rdr,first_line);
...
var G__7735 = matched;
var G__7736 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__7735;
finished = G__7736;
continue;
} else {
...
var _STAR_suppress_read_STAR_7737 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_7737;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env7738 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__7739 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__7739,"(");
...
var G__7740 = (i + (1));
var G__7741 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env7738;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__7742 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__7742);
...
var G__7745 = cljs.core.next.call(null,s);
var G__7746 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__7745;
key_vals = G__7746;
continue;
} else {
...
var gensym_env7750 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env7750;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__7751 = token;
var G__7751__$1 = (((G__7751 == null))?null:cljs.core.subs.call(null,G__7751,(1)));
var G__7751__$2 = (((G__7751__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7751__$1));
var G__7751__$3 = (((G__7751__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7751__$2));
var G__7751__$4 = (((G__7751__$3 == null))?null:cljs.core.symbol.call(null,G__7751__$3));
if((G__7751__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__7751__$4);
}
})():(function (){var G__7752 = token;
var G__7752__$1 = (((G__7752 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__7752));
if((G__7752__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__7752__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e7759){if((e7759 instanceof Error)){
var e = e7759;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__7763,reader){
var map__7764 = p__7763;
var map__7764__$1 = ((((!((map__7764 == null)))?(((((map__7764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7764):map__7764);
var opts = map__7764__$1;
var eof = cljs.core.get.call(null,map__7764__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___7772 = arguments.length;
var i__4532__auto___7773 = (0);
while(true){
if((i__4532__auto___7773 < len__4531__auto___7772)){
args__4534__auto__.push((arguments[i__4532__auto___7773]));

var G__7774 = (i__4532__auto___7773 + (1));
i__4532__auto___7773 = G__7774;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq7770){
var G__7771 = cljs.core.first.call(null,seq7770);
var seq7770__$1 = cljs.core.next.call(null,seq7770);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7771,seq7770__$1);
});
