...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4926 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4926,ch);
...
if(("\\" === ch__$1)){
var ch_4927__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4927__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4927__$2);
} else {
}

var G__4928 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4928;
continue;
}
}
...
var vec__4936 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4936,(0),null);
var start_column = cljs.core.nth.call(null,vec__4936,(1),null);
...
var G__4939 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4939;
continue;
}
}
...
var _STAR_read_delim_STAR_4940 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4940;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4941 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4941,(0),null);
var start_column = cljs.core.nth.call(null,vec__4941,(1),null);
...
var vec__4944 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4944,(0),null);
var end_column = cljs.core.nth.call(null,vec__4944,(1),null);
...
var vec__4947 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4947,(0),null);
var start_column = cljs.core.nth.call(null,vec__4947,(1),null);
...
var vec__4950 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4950,(0),null);
var end_column = cljs.core.nth.call(null,vec__4950,(1),null);
...
var vec__4953 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4953,(0),null);
var start_column = cljs.core.nth.call(null,vec__4953,(1),null);
...
var vec__4956 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4956,(0),null);
var end_column = cljs.core.nth.call(null,vec__4956,(1),null);
...
var sb = (function (){var G__4959 = (new goog.string.StringBuffer());
G__4959.append(initch);
...
var G__4961 = (function (){var G__4960 = sb;
G__4960.append(ch);

return G__4960;
})();
var G__4962 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4961;
ch = G__4962;
continue;
}
...
switch (G__4965) {
case "\\":
var G__4969 = (function (){var G__4966 = sb;
G__4966.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4966;
})();
var G__4970 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4969;
ch = G__4970;
continue;
...
break;
default:
var G__4971 = (function (){var G__4967 = sb;
G__4967.append(ch);

return G__4967;
})();
var G__4972 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4971;
ch = G__4972;
continue;
...
var vec__4973 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4973,(0),null);
var end_column = cljs.core.nth.call(null,vec__4973,(1),null);
...
var vec__4976 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4976,(0),null);
var column = cljs.core.nth.call(null,vec__4976,(1),null);
...
var vec__4981 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4981,(0),null);
var column = cljs.core.nth.call(null,vec__4981,(1),null);
...
var vec__4986 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4986,(0),null);
var column = cljs.core.nth.call(null,vec__4986,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4991 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4991,(0),null);
var start_column = cljs.core.nth.call(null,vec__4991,(1),null);
...
var vec__4994 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4994,(0),null);
var end_column = cljs.core.nth.call(null,vec__4994,(1),null);
...
var G__4997 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4997,true,null,opts,pending_forms);
...
var G__4998 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4998)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4998)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4998)){
...
var _STAR_suppress_read_STAR_4999 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4999;
}});
...
var G__5000 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__5000,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__5000,rdr,first_line);
...
var G__5004 = matched;
var G__5005 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__5004;
finished = G__5005;
continue;
} else {
...
var _STAR_suppress_read_STAR_5006 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5006;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env5007 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__5008 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5008,"(");
...
var G__5009 = (i + (1));
var G__5010 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env5007;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__5011 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__5011);
...
var G__5012 = cljs.core.next.call(null,s__$1);
var G__5013 = ret;
s__$1 = G__5012;
r = G__5013;
continue;
...
var G__5015 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__5014;
key_vals = G__5015;
continue;
} else {
...
var gensym_env5019 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env5019;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__5020 = token;
var G__5020__$1 = (((G__5020 == null))?null:cljs.core.subs.call(null,G__5020,(1)));
var G__5020__$2 = (((G__5020__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5020__$1));
var G__5020__$3 = (((G__5020__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5020__$2));
var G__5020__$4 = (((G__5020__$3 == null))?null:cljs.core.symbol.call(null,G__5020__$3));
if((G__5020__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__5020__$4);
}
})():(function (){var G__5021 = token;
var G__5021__$1 = (((G__5021 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5021));
if((G__5021__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5021__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e5028){if((e5028 instanceof Error)){
var e = e5028;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__5032,reader){
...
var opts = map__5033__$1;
var eof = cljs.core.get.call(null,map__5033__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___5041 = arguments.length;
var i__4532__auto___5042 = (0);
while(true){
if((i__4532__auto___5042 < len__4531__auto___5041)){
args__4534__auto__.push((arguments[i__4532__auto___5042]));

var G__5043 = (i__4532__auto___5042 + (1));
i__4532__auto___5042 = G__5043;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq5039){
var G__5040 = cljs.core.first.call(null,seq5039);
var seq5039__$1 = cljs.core.next.call(null,seq5039);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5040,seq5039__$1);
});
