...
var G__4723 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4723;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4724 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4724,ch);
...
if(("\\" === ch__$1)){
var ch_4725__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4725__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4725__$2);
} else {
}

var G__4726 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4726;
continue;
}
}
...
var vec__4734 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4734,(0),null);
var start_column = cljs.core.nth.call(null,vec__4734,(1),null);
...
var G__4737 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4737;
continue;
}
}
...
var _STAR_read_delim_STAR_4738 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4738;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4739 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4739,(0),null);
var start_column = cljs.core.nth.call(null,vec__4739,(1),null);
...
var vec__4742 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4742,(0),null);
var end_column = cljs.core.nth.call(null,vec__4742,(1),null);
...
var vec__4745 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4745,(0),null);
var start_column = cljs.core.nth.call(null,vec__4745,(1),null);
...
var vec__4748 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4748,(0),null);
var end_column = cljs.core.nth.call(null,vec__4748,(1),null);
...
var vec__4751 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4751,(0),null);
var start_column = cljs.core.nth.call(null,vec__4751,(1),null);
...
var vec__4754 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4754,(0),null);
var end_column = cljs.core.nth.call(null,vec__4754,(1),null);
...
var sb = (function (){var G__4757 = (new goog.string.StringBuffer());
G__4757.append(initch);
...
var G__4759 = (function (){var G__4758 = sb;
G__4758.append(ch);

return G__4758;
})();
var G__4760 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4759;
ch = G__4760;
continue;
}
...
switch (G__4763) {
case "\\":
var G__4767 = (function (){var G__4764 = sb;
G__4764.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4764;
})();
var G__4768 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4767;
ch = G__4768;
continue;
...
break;
default:
var G__4769 = (function (){var G__4765 = sb;
G__4765.append(ch);
...
var vec__4771 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4771,(0),null);
var end_column = cljs.core.nth.call(null,vec__4771,(1),null);
...
var vec__4774 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4774,(0),null);
var column = cljs.core.nth.call(null,vec__4774,(1),null);
...
var vec__4779 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4779,(0),null);
var column = cljs.core.nth.call(null,vec__4779,(1),null);
...
var vec__4784 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4784,(0),null);
var column = cljs.core.nth.call(null,vec__4784,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4789 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4789,(0),null);
var start_column = cljs.core.nth.call(null,vec__4789,(1),null);
...
var vec__4792 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4792,(0),null);
var end_column = cljs.core.nth.call(null,vec__4792,(1),null);
...
var G__4795 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4795,true,null,opts,pending_forms);
...
var G__4796 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4796)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4796)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4796)){
...
var _STAR_suppress_read_STAR_4797 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4797;
}});
...
var G__4798 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4798,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4798,rdr,first_line);
...
var G__4802 = matched;
var G__4803 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4802;
finished = G__4803;
continue;
} else {
...
var _STAR_suppress_read_STAR_4804 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4804;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4805 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4806 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4806,"(");
...
var G__4807 = (i + (1));
var G__4808 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4805;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4809 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4809);
...
var G__4810 = cljs.core.next.call(null,s__$1);
var G__4811 = ret;
s__$1 = G__4810;
r = G__4811;
continue;
...
var G__4812 = cljs.core.next.call(null,s);
var G__4813 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4812;
key_vals = G__4813;
continue;
} else {
...
var gensym_env4817 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4817;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4818 = token;
var G__4818__$1 = (((G__4818 == null))?null:cljs.core.subs.call(null,G__4818,(1)));
var G__4818__$2 = (((G__4818__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4818__$1));
var G__4818__$3 = (((G__4818__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4818__$2));
var G__4818__$4 = (((G__4818__$3 == null))?null:cljs.core.symbol.call(null,G__4818__$3));
if((G__4818__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4818__$4);
}
})():(function (){var G__4819 = token;
var G__4819__$1 = (((G__4819 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4819));
if((G__4819__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4819__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e4826){if((e4826 instanceof Error)){
var e = e4826;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4830,reader){
var map__4831 = p__4830;
var map__4831__$1 = ((((!((map__4831 == null)))?(((((map__4831.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4831.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4831):map__4831);
var opts = map__4831__$1;
var eof = cljs.core.get.call(null,map__4831__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4837){
var G__4838 = cljs.core.first.call(null,seq4837);
var seq4837__$1 = cljs.core.next.call(null,seq4837);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4838,seq4837__$1);
});
