...
var G__4837 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4837;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4838 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4838,ch);
...
var vec__4848 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4848,(0),null);
var start_column = cljs.core.nth.call(null,vec__4848,(1),null);
...
var G__4851 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4851;
continue;
}
}
...
var _STAR_read_delim_STAR_4852 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4852;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4853 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4853,(0),null);
var start_column = cljs.core.nth.call(null,vec__4853,(1),null);
...
var vec__4856 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4856,(0),null);
var end_column = cljs.core.nth.call(null,vec__4856,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__4859,(0),null);
var start_column = cljs.core.nth.call(null,vec__4859,(1),null);
...
var vec__4862 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4862,(0),null);
var end_column = cljs.core.nth.call(null,vec__4862,(1),null);
...
var sb = (function (){var G__4871 = (new goog.string.StringBuffer());
G__4871.append(initch);
...
var G__4873 = (function (){var G__4872 = sb;
G__4872.append(ch);

return G__4872;
})();
var G__4874 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4873;
ch = G__4874;
continue;
}
...
switch (G__4877) {
case "\\":
var G__4881 = (function (){var G__4878 = sb;
G__4878.append(cljs.tools.reader.escape_char.call(null,sb,reader));
...
break;
default:
var G__4883 = (function (){var G__4879 = sb;
G__4879.append(ch);

return G__4879;
})();
var G__4884 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4883;
ch = G__4884;
continue;
...
var vec__4885 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4885,(0),null);
var end_column = cljs.core.nth.call(null,vec__4885,(1),null);
...
var vec__4888 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4888,(0),null);
var column = cljs.core.nth.call(null,vec__4888,(1),null);
...
var vec__4893 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4893,(0),null);
var column = cljs.core.nth.call(null,vec__4893,(1),null);
...
var line = cljs.core.nth.call(null,vec__4898,(0),null);
var column = cljs.core.nth.call(null,vec__4898,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4903 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4903,(0),null);
var start_column = cljs.core.nth.call(null,vec__4903,(1),null);
...
var vec__4906 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4906,(0),null);
var end_column = cljs.core.nth.call(null,vec__4906,(1),null);
...
var G__4909 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4909,true,null,opts,pending_forms);
...
var G__4910 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4910)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4910)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4910)){
...
var _STAR_suppress_read_STAR_4911 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4911;
}});
...
var G__4912 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4912,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4912,rdr,first_line);
...
var G__4916 = matched;
var G__4917 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4916;
finished = G__4917;
continue;
} else {
...
var _STAR_suppress_read_STAR_4918 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4918;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4919 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4920 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4920,"(");
...
var G__4921 = (i + (1));
var G__4922 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4919;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4923 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4923);
...
var G__4924 = cljs.core.next.call(null,s__$1);
var G__4925 = ret;
s__$1 = G__4924;
r = G__4925;
continue;
...
var G__4926 = cljs.core.next.call(null,s);
var G__4927 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4926;
key_vals = G__4927;
continue;
} else {
...
var gensym_env4931 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4931;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4932 = token;
var G__4932__$1 = (((G__4932 == null))?null:cljs.core.subs.call(null,G__4932,(1)));
var G__4932__$2 = (((G__4932__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4932__$1));
var G__4932__$3 = (((G__4932__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4932__$2));
var G__4932__$4 = (((G__4932__$3 == null))?null:cljs.core.symbol.call(null,G__4932__$3));
if((G__4932__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4932__$4);
}
})():(function (){var G__4933 = token;
var G__4933__$1 = (((G__4933 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4933));
if((G__4933__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4933__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e4940){if((e4940 instanceof Error)){
var e = e4940;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4944,reader){
...
var opts = map__4945__$1;
var eof = cljs.core.get.call(null,map__4945__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4951){
var G__4952 = cljs.core.first.call(null,seq4951);
var seq4951__$1 = cljs.core.next.call(null,seq4951);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4952,seq4951__$1);
});
