...
var G__5261 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__5261;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__5262 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5262,ch);
...
if(("\\" === ch__$1)){
var ch_5263__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_5263__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_5263__$2);
} else {
}

var G__5264 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__5264;
continue;
}
}
...
var vec__5272 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5272,(0),null);
var start_column = cljs.core.nth.call(null,vec__5272,(1),null);
...
var G__5275 = cljs.core.conj_BANG_.call(null,a,form);
a = G__5275;
continue;
}
}
...
var _STAR_read_delim_STAR_5276 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_5276;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__5277 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5277,(0),null);
var start_column = cljs.core.nth.call(null,vec__5277,(1),null);
...
var vec__5280 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5280,(0),null);
var end_column = cljs.core.nth.call(null,vec__5280,(1),null);
...
var vec__5283 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5283,(0),null);
var start_column = cljs.core.nth.call(null,vec__5283,(1),null);
...
var vec__5286 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5286,(0),null);
var end_column = cljs.core.nth.call(null,vec__5286,(1),null);
...
var vec__5289 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__5292 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5292,(0),null);
var end_column = cljs.core.nth.call(null,vec__5292,(1),null);
...
var sb = (function (){var G__5295 = (new goog.string.StringBuffer());
G__5295.append(initch);
...
var G__5297 = (function (){var G__5296 = sb;
G__5296.append(ch);

return G__5296;
})();
var G__5298 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__5297;
ch = G__5298;
continue;
}
...
switch (G__5301) {
case "\\":
var G__5305 = (function (){var G__5302 = sb;
G__5302.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__5302;
})();
var G__5306 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5305;
ch = G__5306;
continue;
...
break;
default:
var G__5307 = (function (){var G__5303 = sb;
G__5303.append(ch);

return G__5303;
})();
var G__5308 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5307;
ch = G__5308;
continue;
...
var vec__5309 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5309,(0),null);
var end_column = cljs.core.nth.call(null,vec__5309,(1),null);
...
var vec__5312 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5312,(0),null);
var column = cljs.core.nth.call(null,vec__5312,(1),null);
...
var vec__5317 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5317,(0),null);
var column = cljs.core.nth.call(null,vec__5317,(1),null);
...
var vec__5322 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5322,(0),null);
var column = cljs.core.nth.call(null,vec__5322,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__5327 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5327,(0),null);
var start_column = cljs.core.nth.call(null,vec__5327,(1),null);
...
var vec__5330 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5330,(0),null);
var end_column = cljs.core.nth.call(null,vec__5330,(1),null);
...
var G__5333 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__5333,true,null,opts,pending_forms);
...
var G__5334 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__5334)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__5334)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__5334)){
...
var _STAR_suppress_read_STAR_5335 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5335;
}});
...
var G__5336 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__5336,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__5336,rdr,first_line);
...
var G__5340 = matched;
var G__5341 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__5340;
finished = G__5341;
continue;
} else {
...
var _STAR_suppress_read_STAR_5342 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5342;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env5343 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__5344 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5344,"(");
...
var G__5345 = (i + (1));
var G__5346 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env5343;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__5347 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__5347);
...
var G__5350 = cljs.core.next.call(null,s);
var G__5351 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__5350;
key_vals = G__5351;
continue;
} else {
...
var gensym_env5355 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env5355;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__5356 = token;
var G__5356__$1 = (((G__5356 == null))?null:cljs.core.subs.call(null,G__5356,(1)));
var G__5356__$2 = (((G__5356__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5356__$1));
var G__5356__$3 = (((G__5356__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5356__$2));
var G__5356__$4 = (((G__5356__$3 == null))?null:cljs.core.symbol.call(null,G__5356__$3));
if((G__5356__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__5356__$4);
}
})():(function (){var G__5357 = token;
var G__5357__$1 = (((G__5357 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5357));
if((G__5357__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5357__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__5368,reader){
var map__5369 = p__5368;
var map__5369__$1 = ((((!((map__5369 == null)))?(((((map__5369.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5369.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5369):map__5369);
var opts = map__5369__$1;
var eof = cljs.core.get.call(null,map__5369__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___5377 = arguments.length;
var i__4532__auto___5378 = (0);
while(true){
if((i__4532__auto___5378 < len__4531__auto___5377)){
args__4534__auto__.push((arguments[i__4532__auto___5378]));

var G__5379 = (i__4532__auto___5378 + (1));
i__4532__auto___5378 = G__5379;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq5375){
var G__5376 = cljs.core.first.call(null,seq5375);
var seq5375__$1 = cljs.core.next.call(null,seq5375);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5376,seq5375__$1);
});
