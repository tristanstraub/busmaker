...
var G__5247 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__5247;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__5248 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5248,ch);
...
if(("\\" === ch__$1)){
var ch_5249__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_5249__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_5249__$2);
} else {
}

var G__5250 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__5250;
continue;
}
}
...
var vec__5258 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5258,(0),null);
var start_column = cljs.core.nth.call(null,vec__5258,(1),null);
...
var G__5261 = cljs.core.conj_BANG_.call(null,a,form);
a = G__5261;
continue;
}
}
...
var _STAR_read_delim_STAR_5262 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_5262;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__5263 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5263,(0),null);
var start_column = cljs.core.nth.call(null,vec__5263,(1),null);
...
var vec__5266 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5266,(0),null);
var end_column = cljs.core.nth.call(null,vec__5266,(1),null);
...
var vec__5269 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5269,(0),null);
var start_column = cljs.core.nth.call(null,vec__5269,(1),null);
...
var vec__5272 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5272,(0),null);
var end_column = cljs.core.nth.call(null,vec__5272,(1),null);
...
var vec__5275 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5275,(0),null);
var start_column = cljs.core.nth.call(null,vec__5275,(1),null);
...
var vec__5278 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5278,(0),null);
var end_column = cljs.core.nth.call(null,vec__5278,(1),null);
...
var sb = (function (){var G__5281 = (new goog.string.StringBuffer());
G__5281.append(initch);
...
var G__5283 = (function (){var G__5282 = sb;
G__5282.append(ch);

return G__5282;
})();
var G__5284 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__5283;
ch = G__5284;
continue;
}
...
switch (G__5287) {
case "\\":
var G__5291 = (function (){var G__5288 = sb;
G__5288.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__5288;
})();
var G__5292 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5291;
ch = G__5292;
continue;
...
break;
default:
var G__5293 = (function (){var G__5289 = sb;
G__5289.append(ch);

return G__5289;
})();
var G__5294 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__5293;
ch = G__5294;
continue;
...
var vec__5295 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5295,(0),null);
var end_column = cljs.core.nth.call(null,vec__5295,(1),null);
...
var vec__5298 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5298,(0),null);
var column = cljs.core.nth.call(null,vec__5298,(1),null);
...
var vec__5303 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5303,(0),null);
var column = cljs.core.nth.call(null,vec__5303,(1),null);
...
var vec__5308 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__5308,(0),null);
var column = cljs.core.nth.call(null,vec__5308,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__5313 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__5313,(0),null);
var start_column = cljs.core.nth.call(null,vec__5313,(1),null);
...
var vec__5316 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__5316,(0),null);
var end_column = cljs.core.nth.call(null,vec__5316,(1),null);
...
var G__5319 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__5319,true,null,opts,pending_forms);
...
var G__5320 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__5320)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__5320)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__5320)){
...
var _STAR_suppress_read_STAR_5321 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5321;
}});
...
var G__5322 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__5322,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__5322,rdr,first_line);
...
var G__5326 = matched;
var G__5327 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__5326;
finished = G__5327;
continue;
} else {
...
var _STAR_suppress_read_STAR_5328 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_5328;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env5329 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__5330 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__5330,"(");
...
var G__5331 = (i + (1));
var G__5332 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env5329;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__5333 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__5333);
...
var G__5337 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__5336;
key_vals = G__5337;
continue;
} else {
...
var gensym_env5341 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env5341;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__5342 = token;
var G__5342__$1 = (((G__5342 == null))?null:cljs.core.subs.call(null,G__5342,(1)));
var G__5342__$2 = (((G__5342__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5342__$1));
var G__5342__$3 = (((G__5342__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5342__$2));
var G__5342__$4 = (((G__5342__$3 == null))?null:cljs.core.symbol.call(null,G__5342__$3));
if((G__5342__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__5342__$4);
}
})():(function (){var G__5343 = token;
var G__5343__$1 = (((G__5343 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__5343));
if((G__5343__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__5343__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e5350){if((e5350 instanceof Error)){
var e = e5350;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__5354,reader){
var map__5355 = p__5354;
var map__5355__$1 = ((((!((map__5355 == null)))?(((((map__5355.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5355.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__5355):map__5355);
var opts = map__5355__$1;
var eof = cljs.core.get.call(null,map__5355__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___5363 = arguments.length;
var i__4532__auto___5364 = (0);
while(true){
if((i__4532__auto___5364 < len__4531__auto___5363)){
args__4534__auto__.push((arguments[i__4532__auto___5364]));

var G__5365 = (i__4532__auto___5364 + (1));
i__4532__auto___5364 = G__5365;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq5361){
var G__5362 = cljs.core.first.call(null,seq5361);
var seq5361__$1 = cljs.core.next.call(null,seq5361);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5362,seq5361__$1);
});
