...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4839 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4839,ch);
...
if(("\\" === ch__$1)){
var ch_4840__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4840__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4840__$2);
} else {
}

var G__4841 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4841;
continue;
}
}
...
var vec__4849 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var G__4852 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4852;
continue;
}
}
...
var _STAR_read_delim_STAR_4853 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4853;
}});
/**
...
var start_line = cljs.core.nth.call(null,vec__4854,(0),null);
var start_column = cljs.core.nth.call(null,vec__4854,(1),null);
...
var vec__4857 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4857,(0),null);
var end_column = cljs.core.nth.call(null,vec__4857,(1),null);
...
var vec__4863 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4863,(0),null);
var end_column = cljs.core.nth.call(null,vec__4863,(1),null);
...
var vec__4866 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4866,(0),null);
var start_column = cljs.core.nth.call(null,vec__4866,(1),null);
...
var vec__4869 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4869,(0),null);
var end_column = cljs.core.nth.call(null,vec__4869,(1),null);
...
var sb = (function (){var G__4872 = (new goog.string.StringBuffer());
G__4872.append(initch);
...
var G__4874 = (function (){var G__4873 = sb;
G__4873.append(ch);

return G__4873;
})();
var G__4875 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4874;
ch = G__4875;
continue;
}
...
switch (G__4878) {
case "\\":
var G__4882 = (function (){var G__4879 = sb;
G__4879.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4879;
})();
var G__4883 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4882;
ch = G__4883;
continue;
...
break;
default:
var G__4884 = (function (){var G__4880 = sb;
G__4880.append(ch);

return G__4880;
})();
var G__4885 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4884;
ch = G__4885;
continue;
...
var vec__4886 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4886,(0),null);
var end_column = cljs.core.nth.call(null,vec__4886,(1),null);
...
var vec__4889 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4889,(0),null);
var column = cljs.core.nth.call(null,vec__4889,(1),null);
...
var vec__4894 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4894,(0),null);
var column = cljs.core.nth.call(null,vec__4894,(1),null);
...
var vec__4899 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4899,(0),null);
var column = cljs.core.nth.call(null,vec__4899,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__4910 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4910,true,null,opts,pending_forms);
...
var G__4911 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4911)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4911)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4911)){
...
var _STAR_suppress_read_STAR_4912 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4912;
}});
...
var G__4913 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4913,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4913,rdr,first_line);
...
var G__4917 = matched;
var G__4918 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4917;
finished = G__4918;
continue;
} else {
...
var _STAR_suppress_read_STAR_4919 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4919;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4920 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4921 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4921,"(");
...
var G__4922 = (i + (1));
var G__4923 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4920;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4924 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4924);
...
var G__4925 = cljs.core.next.call(null,s__$1);
var G__4926 = ret;
s__$1 = G__4925;
r = G__4926;
continue;
...
var G__4928 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4927;
key_vals = G__4928;
continue;
} else {
...
var gensym_env4932 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4932;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4933 = token;
var G__4933__$1 = (((G__4933 == null))?null:cljs.core.subs.call(null,G__4933,(1)));
var G__4933__$2 = (((G__4933__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4933__$1));
var G__4933__$3 = (((G__4933__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4933__$2));
var G__4933__$4 = (((G__4933__$3 == null))?null:cljs.core.symbol.call(null,G__4933__$3));
if((G__4933__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4933__$4);
}
})():(function (){var G__4934 = token;
var G__4934__$1 = (((G__4934 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4934));
if((G__4934__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4934__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e4941){if((e4941 instanceof Error)){
var e = e4941;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4945,reader){
var map__4946 = p__4945;
var map__4946__$1 = ((((!((map__4946 == null)))?(((((map__4946.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4946.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4946):map__4946);
var opts = map__4946__$1;
var eof = cljs.core.get.call(null,map__4946__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4952){
var G__4953 = cljs.core.first.call(null,seq4952);
var seq4952__$1 = cljs.core.next.call(null,seq4952);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4953,seq4952__$1);
});
